        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                    <img src="assets/images/logo_small.svg" alt="" height="22">
                                </span>
                        <span class="logo-lg">
                    ...
                    <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                    <img src="assets/images/logo_small.svg" alt="" height="50">
                                </span>
                        <span class="logo-lg">
                                    <img src="assets/images/logo.svg" alt="" height="45">
                                </span>
                    </a>
                </div>
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    <button @click="gotTo('/')" type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-none d-xl-inline-block ms-1" key="t-henry">Logout</span>
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled text-capitalize" id="side-menu">
                    <li class="menu-title" key="t-pages">ZUKU </li>
                    ...
                    <li>
                        <a @click="gotTo('attendance')" class="waves-effect">
                            <i class="mdi-clock mdi"></i><span>Attendance</span>
                        </a>
                    </li>
                    ...
                    <li class="">
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a @click="gotTo('agents')">All Agents</a></li>
                            <li><a @click="gotTo('within')">Within Zones</a></li>
                            <li><a @click="gotTo('outside')">Outside Zones</a></li>
                            <li><a @click="gotTo('inactive')">Inactive</a></li>
